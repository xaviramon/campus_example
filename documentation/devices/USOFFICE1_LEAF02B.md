...
| --------- | --------------- | ------------ | --------- |
| USOFFICE1_LEAF02 | Vlan4094 | 192.168.0.4 | Port-Channel49 |
...
| Ethernet52 | L2_USOFFICE1_SPINE02_Ethernet4 | *trunk | *3000 | *- | *- | 51 |
...
interface Ethernet49
   description MLAG_USOFFICE1_LEAF02A_Ethernet49
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description MLAG_USOFFICE1_LEAF02A_Ethernet50
   no shutdown
   channel-group 49 mode active
!
interface Ethernet51
   description L2_USOFFICE1_SPINE01_Ethernet4
   shutdown
   channel-group 51 mode active
!
interface Ethernet52
   description L2_USOFFICE1_SPINE02_Ethernet4
   shutdown
   channel-group 51 mode active
```
...
| Port-Channel49 | MLAG_USOFFICE1_LEAF02A_Port-Channel49 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel49
   description MLAG_USOFFICE1_LEAF02A_Port-Channel49
   no shutdown
   switchport mode trunk
