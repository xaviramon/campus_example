...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 172.16.100.99/24 | - |
...
| --------- | --------------- | ------------ | --------- |
| INOFFICE1_SPINES | Vlan4094 | 192.168.0.1 | Port-Channel49 |
...
!
interface Ethernet1
   description L2_INOFFICE1_LEAF01A_Ethernet51
   shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description L2_INOFFICE1_LEAF01B_Ethernet51
   shutdown
   channel-group 1 mode active
!
interface Ethernet3
   description L2_INOFFICE1_LEAF02A_Ethernet51
   shutdown
...
interface Ethernet48
   description L2_INOFFICE1_INTERNET_LEAF02_Ethernet49
   shutdown
   channel-group 48 mode active
!
interface Ethernet49
   description MLAG_INOFFICE1_SPINE02_Ethernet49
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description MLAG_INOFFICE1_SPINE02_Ethernet50
   no shutdown
   channel-group 49 mode active
```
...
interface Port-Channel49
   description MLAG_INOFFICE1_SPINE02_Port-Channel49
   no shutdown
   switchport mode trunk
